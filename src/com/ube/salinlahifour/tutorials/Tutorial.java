...
public class Tutorial extends Activity{
	...
	private int UserID;
	private boolean isBackVisibleimageView1 = false; // Boolean variable to check if the back image is vis
	private boolean isBackVisibleimageView2 = false; // Boolean variable to check if the back image is vis
	private boolean isBackVisibleimageView3 = false; // Boolean variable to check if the back image is vis
