...
public class EnemyList {
	...
	public void loadEnemy(){
		...
		case "HARD":
					sEnemy[8] = "Tunod";
					question[8]="Arrow - We need Tunod to that can shoot 3 at the same time";
					sEnemy[9] = "Gasuklay";
		...
		case "MEDIUM":
					sEnemy[5] = "Krus";
					question[5]="Cross - We need Krus to shoot in a wide area";
					sEnemy[6] = "Diamante";
					question[6]="Diamond - We need a barier its a laser";
					sEnemy[7] = "Parihaba";
					question[7]="Rectangle - We need Parihaba that shoots from the side";
		case "EASY":
			sEnemy[0] = "Bilog";
			question[0]="Circle - We need Bilog to hit red enemies";
			sEnemy[1] = "Bilog";
			question[1]="Circle We need Bilog to hit red enemies";
			sEnemy[2] = "Parisukat";
			question[2]="Square - We just need a Parisukat to shoot one bullet at him";
			sEnemy[3] = "Bituin";
			question[3]="Star - We need Bituin to hit a lot of enemies";
			sEnemy[4] = "Tatsulok";
			question[4]="Triangle - We need Tatsulok that hits 3 enemies";
		}
	}
