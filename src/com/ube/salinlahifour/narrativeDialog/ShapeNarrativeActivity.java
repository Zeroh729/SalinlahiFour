...
public class ShapeNarrativeActivity extends NarrativeDialog{
	...
	public void initiateScript() {
		script.add(new ScriptLine("Wow we finally got away from that chef.", R.raw.narration_family_1));
		script.add(new ScriptLine("Now we're in a rocket ship! Excited na ako!",R.raw.narration_family_3));
		script.add(new ScriptLine("What's going on here?",R.raw.narration_family_4));
		script.add(new ScriptLine("One of our actors for the show is sick! Can you help us with the show?",R.raw.narration_family_5));
		script.add(new ScriptLine("I guess a little acting won't hurt.",R.raw.narration_family_6));
		script.add(new ScriptLine("Tignan mo. Someone is on the screen " +SalinlahiFour.getLoggedInUser().getName(),R.raw.narration_family_7));
		script.add(new ScriptLine("WORLD DOMINATION",R.raw.narration_family_8));
		script.add(new ScriptLine("Naku! We have to defeat the alien quick!",R.raw.narration_family_6));
		script.add(new ScriptLine("Let's figure out what these buttons do.",R.raw.narration_family_6));
	}
