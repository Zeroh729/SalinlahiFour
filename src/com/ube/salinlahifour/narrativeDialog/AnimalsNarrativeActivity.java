...
public class AnimalsNarrativeActivity extends NarrativeDialog{
	...
	public void initiateScript() {
		script.add(new ScriptLine("This is quite the adventure right?", R.raw.narration_family_1));
		script.add(new ScriptLine("Let's just rest for a while.",R.raw.narration_family_3));
		script.add(new ScriptLine("Alam ko na! Let's take a break inside the zoo!",R.raw.narration_family_4));
		...
		script.add(new ScriptLine("But, can we review first?",R.raw.narration_family_6));
		script.add(new ScriptLine("Ok!",R.raw.narration_family_6));
	}
