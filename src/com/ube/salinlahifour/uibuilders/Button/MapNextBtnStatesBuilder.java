...
public class MapNextBtnStatesBuilder extends AbstractBtnStatesBuilder{

	@Override
	public void buildEnabledState() {
		setEnabledState(R.drawable.btn_map_next);
	}

	@Override
	public void buildPressedState() {
		setEnabledState(R.drawable.btn_map_next_pressed);
	}
